...
public class ProductEditAction implements Action {
	...
	private List<Company> merchants;
	...
	public void setMerchants(List<Company> merchants) {
	...
	public String addProduct() throws Exception {
		...
		merchants = companyDao.getAllCompaniesMerchant();
	...
	public String execute() throws Exception {
		...
		currentProduct.setContentDetail(StringUtil.trimLongDesc(currentProduct.getContentDetail()));
		brands = brandDao.getAllBrands();
		merchants = companyDao.getAllCompaniesMerchant();
		productCategories = productCategoryDao.getAllProductCategories();
