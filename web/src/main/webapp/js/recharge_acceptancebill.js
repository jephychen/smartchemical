...
function uploadAcceptanceBillImg(poNo, formIdStr, uploadIdStr, imgIconIdStr, seq){
	...
	var options ={   
		url:"AcceptanceBillAjax_uploadRechargeAcFile.action?poNo=" + poNo + "&seq=" + seq,  
		type:'post',                    
		data:null,
...
function remove_upload(poNo, formIdStr, seq){
	var options ={   
		url:"AcceptanceBillAjax_removeUploadRechargeAcFile.action?poNo=" + poNo + "&seq=" + seq,  
		type:'post',                    
		data:null,
...
function submitToCheck(requestId){
	...
	billFileUploadForm.action="AcceptanceBillRechargeSubmit.action?requestId=" + requestId;
