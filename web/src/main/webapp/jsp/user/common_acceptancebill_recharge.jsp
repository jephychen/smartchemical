...
<script type="text/javascript" src="./js/recharge_acceptancebill.js" charset="UTF-8"></script>
	...
	<div id="pay_pad">
		...
		<div id="pay_pad_content">
			<div id="pay_pad_content_mypay">
				...
				<div id="pay_pad_content_mypay_totalprice">充值金额 <font class="font_red">￥${amount}</font></div>
			</div>
			<div id="pay_pad_content_mypay">
				<div id="pay_pad_content_mypay_tip">请提交承兑汇票扫描件，同时尽快提交承兑汇票。以免影响充值过程。</div>
			</div>
			<div id="pay_pad_content_items">
				...
				<div id="acceptancebill_uploaddiv1" class="pay_pad_acceptancebill_item">
					<form id="acceptance_bill_upload_form1" enctype="multipart/form-data">
						...
						<div id="acceptance_bill_upload_button" onclick="uploadAcceptanceBillImg(${requestId}, 'acceptance_bill_upload_form1', 'ac_bill_upload1', 'acceptance_bill_img_icon1', '1')">上传</div>
				...
				<div id="acceptancebill_uploaddiv2" class="pay_pad_acceptancebill_item_hidden">
					<form id="acceptance_bill_upload_form2" enctype="multipart/form-data">
						...
						<div id="acceptance_bill_upload_button" onclick="uploadAcceptanceBillImg(${requestId}, 'acceptance_bill_upload_form2', 'ac_bill_upload2', 'acceptance_bill_img_icon2', '2')">上传</div>
						<div class="acceptance_bill_upload_continue" onclick="continue_upload('acceptancebill_uploaddiv3')">继续添加扫描件</div>
						<div class="acceptance_bill_upload_remove" onclick="remove_upload(${requestId}, 'acceptance_bill_upload_form2', '2')">删除</div>
				...
				<div id="acceptancebill_uploaddiv3" class="pay_pad_acceptancebill_item_hidden">
					<form id="acceptance_bill_upload_form3" enctype="multipart/form-data">
						...
						<div id="acceptance_bill_upload_button" onclick="uploadAcceptanceBillImg(${requestId}, 'acceptance_bill_upload_form3', 'ac_bill_upload3', 'acceptance_bill_img_icon3', '3')">上传</div>
						<div class="acceptance_bill_upload_continue" onclick="continue_upload('acceptancebill_uploaddiv4')">继续添加扫描件</div>
						<div class="acceptance_bill_upload_remove" onclick="remove_upload(${requestId}, 'acceptance_bill_upload_form3', '3')">删除</div>
				...
				<div id="acceptancebill_uploaddiv4" class="pay_pad_acceptancebill_item_hidden">
					<form id="acceptance_bill_upload_form4" enctype="multipart/form-data">
						...
						<div id="acceptance_bill_upload_button" onclick="uploadAcceptanceBillImg(${requestId}, 'acceptance_bill_upload_form4', 'ac_bill_upload4', 'acceptance_bill_img_icon4', '4')">上传</div>
						<div class="acceptance_bill_upload_continue" onclick="continue_upload('acceptancebill_uploaddiv5')">继续添加扫描件</div>
						<div class="acceptance_bill_upload_remove" onclick="remove_upload(${requestId}, 'acceptance_bill_upload_form4', '4')">删除</div>
				...
				<div id="acceptancebill_uploaddiv5" class="pay_pad_acceptancebill_item_hidden">
					<form id="acceptance_bill_upload_form5" enctype="multipart/form-data">
						...
						<div id="acceptance_bill_upload_button" onclick="uploadAcceptanceBillImg(${requestId}, 'acceptance_bill_upload_form5', 'ac_bill_upload5', 'acceptance_bill_img_icon5', '5')">上传</div>
						<div class="acceptance_bill_upload_continue" onclick="continue_upload('acceptancebill_uploaddiv6')">继续添加扫描件</div>
						<div class="acceptance_bill_upload_remove" onclick="remove_upload(${requestId}, 'acceptance_bill_upload_form5', '5')">删除</div>
				...
				<div id="acceptancebill_uploaddiv6" class="pay_pad_acceptancebill_item_hidden">
					<form id="acceptance_bill_upload_form6" enctype="multipart/form-data">
						...
						<div id="acceptance_bill_upload_button" onclick="uploadAcceptanceBillImg(${requestId}, 'acceptance_bill_upload_form6', 'ac_bill_upload6', 'acceptance_bill_img_icon6', '6')">上传</div>
						<div class="acceptance_bill_upload_continue" onclick="continue_upload('acceptancebill_uploaddiv7')">继续添加扫描件</div>
						<div class="acceptance_bill_upload_remove" onclick="remove_upload(${requestId}, 'acceptance_bill_upload_form6', '6')">删除</div>
				...
				<div id="acceptancebill_uploaddiv7" class="pay_pad_acceptancebill_item_hidden">
					<form id="acceptance_bill_upload_form7" enctype="multipart/form-data">
						...
						<div id="acceptance_bill_upload_button" onclick="uploadAcceptanceBillImg(${requestId}, 'acceptance_bill_upload_form7', 'ac_bill_upload7', 'acceptance_bill_img_icon7', '7')">上传</div>
						<div class="acceptance_bill_upload_continue" onclick="continue_upload('acceptancebill_uploaddiv8')">继续添加扫描件</div>
						<div class="acceptance_bill_upload_remove" onclick="remove_upload(${requestId}, 'acceptance_bill_upload_form7', '7')">删除</div>
				...
				<div id="acceptancebill_uploaddiv8" class="pay_pad_acceptancebill_item_hidden">
					<form id="acceptance_bill_upload_form8" enctype="multipart/form-data">
						...
						<div id="acceptance_bill_upload_button" onclick="uploadAcceptanceBillImg(${requestId}, 'acceptance_bill_upload_form8', 'ac_bill_upload8', 'acceptance_bill_img_icon8', '8')">上传</div>
						<div class="acceptance_bill_upload_continue" onclick="continue_upload('acceptancebill_uploaddiv9')">继续添加扫描件</div>
						<div class="acceptance_bill_upload_remove" onclick="remove_upload(${requestId}, 'acceptance_bill_upload_form8', '8')">删除</div>
				...
				<div id="acceptancebill_uploaddiv9" class="pay_pad_acceptancebill_item_hidden">
					<form id="acceptance_bill_upload_form9" enctype="multipart/form-data">
						...
						<div id="acceptance_bill_upload_button" onclick="uploadAcceptanceBillImg(${requestId}, 'acceptance_bill_upload_form9', 'ac_bill_upload9', 'acceptance_bill_img_icon9', '9')">上传</div>
						<div class="acceptance_bill_upload_continue" onclick="continue_upload('acceptancebill_uploaddiv10')">继续添加扫描件</div>
						<div class="acceptance_bill_upload_remove" onclick="remove_upload(${requestId}, 'acceptance_bill_upload_form9', '9')">删除</div>
				...
				<div id="acceptancebill_uploaddiv10" class="pay_pad_acceptancebill_item_hidden">
					<form id="acceptance_bill_upload_form10" enctype="multipart/form-data">
						...
						<div id="acceptance_bill_upload_button" onclick="uploadAcceptanceBillImg(${requestId}, 'acceptance_bill_upload_form10', 'ac_bill_upload10', 'acceptance_bill_img_icon10', '10')">上传</div>
						<div class="acceptance_bill_upload_remove" onclick="remove_upload(${requestId}, 'acceptance_bill_upload_form10', '10')">删除</div>
			...
			<div id="pay_pad_content_footer">
				<form id="pay_pad_acceptancebill_submit_form">
					<div class="pay_button" onclick="submitToCheck(${requestId})">
						提交审核
					</div>
				</form>
			</div>
