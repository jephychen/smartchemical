			...
			<div class="my_zhixuan_right_content">
				...
				<div class="product_edit_item">
					...
					<div class="product_edit_item_right">
						<input id="company_edit_companyname" class="product_edit_item_input" value="${company.companyName}" onblur="checkCompanyName()"></input>
				...
				<div class="product_edit_item">
					...
					<div class="product_edit_item_right">
						<input id="company_edit_companyfullname" class="product_edit_item_input" value="${company.companyFullName}" onblur="checkCompanyFullName()"></input>
					...
					<div class="product_edit_item_right">
						<select id="company_edit_companytype" class="product_edit_item_select">
							...
							<s:else>
								...
								<option selected="selected" value="2">经销商</option>
							</s:else>
						</select>
				...
				<div class="product_edit_item">
					...
					<div class="product_edit_item_right">
						<input id="company_edit_companyurl" class="product_edit_item_input" value="${company.companyUrl}" onblur="checkCompanyUrl()"></input>
				...
				<div class="product_edit_item">
					...
					<div class="product_edit_item_right">
						<input id="company_edit_desc" class="product_edit_item_input_long" value="${company.description}" onblur="checkCompanyDesc()"></input>
					...
					<div class="product_edit_item_right">
						<select id="pop_content_region_dropdown" class="product_edit_item_select" onchange="regionSelect()">
							...
							<s:iterator value="regions" id="region">
								<s:if test='#region.regionId == company.companyCity.province.region.regionId'>
						...
						<select id="pop_content_province_dropdown" class="product_edit_item_select" onchange="provinceSelect()">
							...
							<s:iterator value="provinces" id="province">
								<s:if test='#province.provinceId == company.companyCity.province.provinceId'>
						...
						<select id="pop_content_city_dropdown"  class="product_edit_item_select" onchange="checkCity()">
							...
							<s:iterator value="cities" id="city">
								<s:if test='#city.cityId == company.companyCity.cityId'>
				...
				<div class="product_edit_item">
					...
					<div class="product_edit_item_right">
						<input id="company_edit_address" class="product_edit_item_input_long" value="${company.companyAddress}" onblur="checkCompanyAddress()"></input>
				...
				<div class="product_edit_item">
					...
					<div class="product_edit_item_right">
						<input id="company_edit_longtitude" class="product_edit_item_input_short" value="${company.longitude}" onblur="checkLongitude()"></input>
						<div class="company_edit_text">纬度：</div>
						<input id="company_edit_latitude" class="product_edit_item_input_short" value="${company.latitude}" onblur="checkLatitude()"></input>
				...
				<div class="product_edit_item">
					...
					<div class="product_edit_item_right">
						<input id="company_edit_slogan" class="product_edit_item_input_long" value="${company.companySlogan}" onblur="checkSlogan()"></input>
				...
				<div class="acceptance_bill_img"><img id="company_edit_pic_icon1" class="company_icon_upload_small" src="${company.companyIcon}" /></div>
				...
				<div class="product_edit_title1">
					...
					<div class="product_edit_item_right">
						<div class="product_edit_save_button hover_pointer" onclick="saveCompany(${queryType},${company.companyId})">
							保存
						</div>
					</div>
				</div>
