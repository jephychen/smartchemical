...
<script type="text/javascript" src="./js/admin_product_edit.js" charset="UTF-8"></script>
			...
			<div class="my_zhixuan_right_content">
				...
				<div class="product_edit_item">
					...
					<div class="product_edit_item_right">
						<input id="product_edit_productname" class="product_edit_item_input" onblur="checkProductName()" ></input>
				...
				<div class="product_edit_item">
					...
					<div class="product_edit_item_right">
						<input id="product_edit_productno" class="product_edit_item_input" onblur="checkProductNo()"></input>
				...
				<div class="product_edit_item">
					<div class="product_edit_item_left">
						<div class="product_edit_item_left_text">经销商：</div>
					</div>
					<div class="product_edit_item_right">
						<select id="pop_content_merchantcompany_dropdown" class="product_edit_item_select">
							<option value="0">选择经销商</option>
							<s:iterator value="merchants" id="merchant">
								<option value="${merchant.companyId}">${merchant.companyName}</option>
							</s:iterator>
						</select>
						<div class="product_edit_text"><font class="font_gray">（可以不选）</font></div>
					</div>
				</div>
				<div class="product_edit_item">
					<div class="product_edit_item_left">
					...
					<div class="product_edit_item_right">
						<input id="product_edit_desc" class="product_edit_item_input_long" onblur="checkProductDesc()"></input>
						<div id="pop_content_productdesc" class="pop_content_input_tip1_hidden">请输入4~36位汉字或英文</div>
					</div>
				</div>
				<div class="product_edit_item">
					<div class="product_edit_item_left">
					...
					<div class="product_edit_item_right">
						<input id="product_edit_price" class="product_edit_item_input_short" onblur="checkProductPrice()"></input>
						<select id="pop_content_priceunit_dropdown" class="product_edit_item_select">
							<s:iterator value="priceUnits" id="priceUnit">
								<option value="${priceUnit.unitId}">${priceUnit.unitName}</option>
							</s:iterator>
						</select>
						<div class="product_edit_text"><font class="font_gray">每</font></div>
						<select id="pop_content_quantityunit_dropdown" class="product_edit_item_select" onchange="quantityDropdownChange()">
					...
					<div class="product_edit_item_right">
						...
						<div class="product_edit_text">
							<font class="font_red">&nbsp&nbsp
								<span id="new_warehouse_button" class="hide_me" onclick="showWarehouseDialog()">新建仓库</span>
							</font>
						</div>
				...
				<div class="product_edit_item">
					...
					<div class="product_edit_item_right">
						<input id="product_edit_stocklevel" class="product_edit_item_input_short" onblur="checkStockLevel()"></input> 
						<div class="product_edit_text"><font id="stocklevel_unit" class="font_gray">吨</font></div>
				...
				<div class="product_edit_item">
					...
					<div class="product_edit_item_right">
						<input id="product_edit_minsoldquantity" class="product_edit_item_input_short" onblur="checkMinSoldQuantity()"></input> 
						<div class="product_edit_text"><font id="stocklevel_unit" class="font_gray">吨</font></div>
				...
				<div class="acceptance_bill_img"><img id="product_edit_pic_icon1" class="acceptance_bill_small" /></div>
				<div class="product_edit_item_big">
					<div class="product_edit_item_left">
						<div class="product_edit_item_left_text">产品长描述：</div>
					</div>
					<div class="product_edit_item_right">
						<textarea id="product_edit_productlongdesc" class="product_edit_item_textarea" rows="15" cols="100">
						</textarea>
					</div>
				</div>
				<div class="product_edit_title1">
					...
					<div class="product_edit_item_right">
						<div class="product_edit_save_button hover_pointer" onclick="saveProduct(${queryType},'0')">
							保存
						</div>
					</div>
				</div>
