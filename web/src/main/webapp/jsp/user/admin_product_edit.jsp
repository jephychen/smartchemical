	...
	<div id="my_zhixuan_wrapper">
		...
		<div id="my_zhixuan_right">
			...
			<div class="my_zhixuan_right_content">
				...
				<s:if test='currentProduct.merchantCompany != ""'>
					<div class="product_edit_item_hidden">
						<div class="product_edit_item_left">
						...
						<div class="product_edit_item_right">
							<select id="pop_content_merchantcompany_dropdown" class="product_edit_item_select">
								...
								<s:iterator value="merchants" id="merchant">
									<s:if test='#merchant.companyId == currentProduct.merchantCompany.companyId'>
										<option selected="selected" value="${merchant.companyId}">${merchant.companyName}</option>
									</s:if>
									<s:else>
