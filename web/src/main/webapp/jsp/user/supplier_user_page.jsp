...
<script type="text/javascript" src="./js/merchant_query_order.js" charset="UTF-8"></script>
</head>
	...
	<div id="top_navigator_wrapper">
		...
		<div class="user_page_navi">
			<ul>
				...
				<a href="${pageActionName}_allOrders.action">
		...
		<div id="my_zhixuan_left">
			<div class="my_zhixuan_menu_group">
				<ul>
					...
					<li class="my_zhixuan_left_li">
						<a href="${pageActionName}_waitingReceived.action">
					...
					<li class="my_zhixuan_left_li">
						<a href="${pageActionName}_waitingGot.action">
					...
					<li class="my_zhixuan_left_li">
						<a href="${pageActionName}_doneOrder.action">
				...
				<div class="my_zhixuan_right_content_order_item">
					...
					<div class="my_zhixuan_right_content_order_item_content">
						<div class="my_zhixuan_right_content_order_item_productlist_wrapper">
							...
							<s:if test='#orderItem.product.company.companyId == #session.user.company.companyId || #orderItem.product.merchantCompany.companyId == #session.user.company.companyId'>
								<div class="my_zhixuan_right_content_order_item_product">
							</s:if>
							<s:else>
								<div class="my_zhixuan_right_content_order_item_product_opacity">
							</s:else>
										...
										<div class="content_order_item_product_quantity_wrapper">
											<s:if test='queryType == "0"'>
												...
												<s:if test='#orderItem.orderItemStatus == "1"'>
													<div>正在发货</div>
													<s:if test='#orderItem.product.company.companyId == #session.user.company.companyId || #orderItem.product.merchantCompany.companyId == #session.user.company.companyId'>
														<div class="product_item_operation" onclick="confirmDeliver(${orderItem.orderItemId}, ${queryType}, ${currentPage}, ${lastMonth}, '${pageActionName}')"><font class="font_red">确认发货</font></div>
													</s:if>
												</s:if>
				...
				<div id="content_paginator">
					<ul class="content_paginator_ul">
						<li class="content_paginator_li content_paginator_number_onhover">
							<s:if test='queryType == "0"'>
								<a href="${pageActionName}_allOrders.action?currentPage=${paginator.prePage}&queryType=${queryType}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">上一页</div>
								</a>
							</s:if>
							<s:elseif test='queryType == "1"'>
								<a href="${pageActionName}_unpaid.action?currentPage=${paginator.prePage}&queryType=${queryType}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">上一页</div>
								</a>
							</s:elseif>
							<s:elseif test='queryType == "2"'>
								<a href="${pageActionName}_waitingReceived.action?currentPage=${paginator.prePage}&queryType=${queryType}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">上一页</div>
								</a>
							</s:elseif>
							<s:elseif test='queryType == "3"'>
								<a href="${pageActionName}_waitingGot.action?currentPage=${paginator.prePage}&queryType=${queryType}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">上一页</div>
								</a>
							</s:elseif>
							<s:elseif test='queryType == "4"'>
								<a href="${pageActionName}_doneOrder.action?currentPage=${paginator.prePage}&queryType=${queryType}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">上一页</div>
								</a>
							</s:elseif>
							<s:else>
						...
						<li class="content_paginator_li_selected">
							<s:if test='queryType == "0"'>
								<a href="${pageActionName}_allOrders.action?currentPage=1&queryType=${queryType}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_selected">1</div>
								</a>
							</s:if>
							<s:elseif test='queryType == "1"'>
								<a href="${pageActionName}_unpaid.action?currentPage=1&queryType=${queryType}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_selected">1</div>
								</a>
							</s:elseif>
							<s:elseif test='queryType == "2"'>
								<a href="${pageActionName}_waitingReceived.action?currentPage=1&queryType=${queryType}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_selected">1</div>
								</a>
							</s:elseif>
							<s:elseif test='queryType == "3"'>
								<a href="${pageActionName}_waitingGot.action?currentPage=1&queryType=${queryType}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_selected">1</div>
								</a>
							</s:elseif>
							<s:elseif test='queryType == "4"'>
								<a href="${pageActionName}_doneOrder.action?currentPage=1&queryType=${queryType}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_selected">1</div>
								</a>
							</s:elseif>
							<s:else>
						...
						<s:bean name= "org.apache.struts2.util.Counter"  id= "counter" >    
							...
							<s:iterator> 
								...
								<li class="content_paginator_li_selected">
									<s:if test='queryType == "0"'>
										<a href="${pageActionName}_allOrders.action?currentPage=${current-1}&queryType=${queryType}&lastMonth=${lastMonth}">
											<div class="content_paginator_number_selected">${current-1}</div>
										</a>
									</s:if>
									<s:elseif test='queryType == "1"'>
										<a href="${pageActionName}_unpaid.action?currentPage=${current-1}&queryType=${queryType}&lastMonth=${lastMonth}">
											<div class="content_paginator_number_selected">${current-1}</div>
										</a>
									</s:elseif>
									<s:elseif test='queryType == "2"'>
										<a href="${pageActionName}_waitingReceived.action?currentPage=${current-1}&queryType=${queryType}&lastMonth=${lastMonth}">
											<div class="content_paginator_number_selected">${current-1}</div>
										</a>
									</s:elseif>
									<s:elseif test='queryType == "3"'>
										<a href="${pageActionName}_waitingGot.action?currentPage=${current-1}&queryType=${queryType}&lastMonth=${lastMonth}">
											<div class="content_paginator_number_selected">${current-1}</div>
										</a>
									</s:elseif>
									<s:elseif test='queryType == "4"'>
										<a href="${pageActionName}_doneOrder.action?currentPage=${current-1}&queryType=${queryType}&lastMonth=${lastMonth}">
											<div class="content_paginator_number_selected">${current-1}</div>
										</a>
									</s:elseif>
									<s:else>
						...
						<s:if test="paginator.totalPage > 1">
							...
							<li class="content_paginator_li_selected">
								<s:if test='queryType == "0"'>
									<a href="${pageActionName}_allOrders.action?currentPage=${paginator.totalPage}&queryType=${queryType}&lastMonth=${lastMonth}">
										<div class="content_paginator_number_selected">${paginator.totalPage}</div>
									</a>
								</s:if>
								<s:elseif test='queryType == "1"'>
									<a href="${pageActionName}_unpaid.action?currentPage=${paginator.totalPage}&queryType=${queryType}&lastMonth=${lastMonth}">
										<div class="content_paginator_number_selected">${paginator.totalPage}</div>
									</a>
								</s:elseif>
								<s:elseif test='queryType == "2"'>
									<a href="${pageActionName}_waitingReceived.action?currentPage=${paginator.totalPage}&queryType=${queryType}&lastMonth=${lastMonth}">
										<div class="content_paginator_number_selected">${paginator.totalPage}</div>
									</a>
								</s:elseif>
								<s:elseif test='queryType == "3"'>
									<a href="${pageActionName}_waitingGot.action?currentPage=${paginator.totalPage}&queryType=${queryType}&lastMonth=${lastMonth}">
										<div class="content_paginator_number_selected">${paginator.totalPage}</div>
									</a>
								</s:elseif>
								<s:elseif test='queryType == "4"'>
									<a href="${pageActionName}_doneOrder.action?currentPage=${paginator.totalPage}&queryType=${queryType}&lastMonth=${lastMonth}">
										<div class="content_paginator_number_selected">${paginator.totalPage}</div>
									</a>
								</s:elseif>
								<s:else>
						...
						<li class="content_paginator_li content_paginator_number_onhover">
							<s:if test='queryType == "0"'>
								<a href="${pageActionName}_allOrders.action?currentPage=${paginator.nextPage}&queryType=${queryType}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">下一页</div>
								</a>
							</s:if>
							<s:elseif test='queryType == "1"'>
								<a href="${pageActionName}_unpaid.action?currentPage=${paginator.nextPage}&queryType=${queryType}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">下一页</div>
								</a>
							</s:elseif>
							<s:elseif test='queryType == "2"'>
								<a href="${pageActionName}_waitingReceived.action?currentPage=${paginator.nextPage}&queryType=${queryType}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">下一页</div>
								</a>
							</s:elseif>
							<s:elseif test='queryType == "3"'>
								<a href="${pageActionName}_waitingGot.action?currentPage=${paginator.nextPage}&queryType=${queryType}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">下一页</div>
								</a>
							</s:elseif>
							<s:elseif test='queryType == "4"'>
								<a href="${pageActionName}_doneOrder.action?currentPage=${paginator.nextPage}&queryType=${queryType}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">下一页</div>
								</a>
							</s:elseif>
							<s:else>
						...
						<li class="content_paginator_li">
							<s:if test='queryType == "0"'>
								<form name="page_form" action="${pageActionName}_allOrders.action">
							...
							<s:elseif test='queryType == "1"'>
								<form name="page_form" action="${pageActionName}_unpaid.action">
									<div class="content_paginator_elim"><s:textfield name="currentPage" id="page_search" /></div>
									<input type="hidden" name="queryType" value="${queryType}" />
									<input type="hidden" name="lastMonth" value="${lastMonth}" />
								</form>
							...
							<s:elseif test='queryType == "2"'>
								<form name="page_form" action="${pageActionName}_waitingReceived.action">
									<div class="content_paginator_elim"><s:textfield name="currentPage" id="page_search" /></div>
									<input type="hidden" name="queryType" value="${queryType}" />
									<input type="hidden" name="lastMonth" value="${lastMonth}" />
								</form>
							...
							<s:elseif test='queryType == "3"'>
								<form name="page_form" action="${pageActionName}_waitingGot.action">
									<div class="content_paginator_elim"><s:textfield name="currentPage" id="page_search" /></div>
									<input type="hidden" name="queryType" value="${queryType}" />
									<input type="hidden" name="lastMonth" value="${lastMonth}" />
								</form>
							...
							<s:elseif test='queryType == "4"'>
								<form name="page_form" action="${pageActionName}_doneOrder.action">
									<div class="content_paginator_elim"><s:textfield name="currentPage" id="page_search" /></div>
									<input type="hidden" name="queryType" value="${queryType}" />
									<input type="hidden" name="lastMonth" value="${lastMonth}" />
								</form>
