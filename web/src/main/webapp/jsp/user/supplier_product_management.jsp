...
<script type="text/javascript" src="./js/supplier_product_management.js" charset="UTF-8"></script>
</head>
...
<div id="top_navigator_red_bg">
	<div id="top_navigator_wrapper">
		...
		<div class="user_page_navi">
			<ul>
				<a href="SupplierProductManagement_allProducts.action">
				<li class="user_page_navi_li_selected hover_pointer">
					产品管理
				</li>
				</a>
				<a href="SupplierQueryOrder_allOrders.action">
		...
		<div id="my_zhixuan_left">
			<div class="my_zhixuan_menu_group">
				<ul>
					...
					<li class="my_zhixuan_left_li">
						<a href="SupplierProductManagement_disabledProducts.action">
			...
			<div class="my_zhixuan_right_content">
				...
				<div class="product_list_filters">
					<div class="product_list_filter_item">
						...
						<div class="product_list_filter_item_right">
							<input id="product_list_search_input" class="product_list_filter_item_input" value="${keyword}" onkeydown="if(event.keyCode==13){submit_product_search_form(${queryType}, ${companyIdSelected});}" />
						</div>
					</div>
					<!--div class="product_list_filter_item">
						<div class="product_list_filter_item_left">
						...
						<div class="product_list_filter_item_right">
							<select id="product_list_search_company_dropdown" class="product_list_filter_item_select" onchange="companyFilterSelect(${queryType}, ${companyIdSelected})" >
								<option value="0">所有品牌</option>
								<s:iterator value="companies" id="company">
									<s:if test='#company.companyId == companyIdSelected'>
					...
					<a href="SupplierProductAdd.action?queryType=${queryType}">
				...
				<div class="order_page_product_item">
					...
					<div class="order_page_product_item_op_col">
						<a href="SupplierProductEdit.action?productId=${product.productId}&queryType=${queryType}"><font class="order_page_font_red"><div class="order_page_product_price_wrapper hover_pointer">修改</div></font></a>
						<s:if test='queryType != "3"'>
							<font class="order_page_font_red"><div class="order_page_product_price_wrapper hover_pointer" onclick="deleteProduct(${queryType}, ${product.productId}, ${companyIdSelected}, ${currentPage})">下架</div></font>
						</s:if>
						<s:else>
							<font class="order_page_font_red"><div class="order_page_product_price_wrapper hover_pointer" onclick="restoreProduct(${queryType}, ${product.productId}, ${companyIdSelected}, ${currentPage})">上架</div></font>
						</s:else>
					</div>
				</div>
				</s:iterator>
				<div id="content_paginator">
					<ul class="content_paginator_ul">
						<li class="content_paginator_li content_paginator_number_onhover">
							<s:if test='queryType == "0"'>
								<a href="${paginator.actionName}_allProducts.action?currentPage=${paginator.prePage}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">上一页</div>
								</a>
							</s:if>
							<s:elseif test='queryType == "1"'>
								<a href="${paginator.actionName}_supplierProducts.action?currentPage=${paginator.prePage}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">上一页</div>
								</a>
							</s:elseif>
							<s:elseif test='queryType == "2"'>
								<a href="${paginator.actionName}_merchantProducts.action?currentPage=${paginator.prePage}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">上一页</div>
								</a>
							</s:elseif>
							<s:elseif test='queryType == "3"'>
								<a href="${paginator.actionName}_disabledProducts.action?currentPage=${paginator.prePage}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">上一页</div>
								</a>
							</s:elseif>
							<s:else>
						...
						<li class="content_paginator_li_selected">
							<s:if test='queryType == "0"'>
								<a href="${paginator.actionName}_allProducts.action?currentPage=1&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_selected">1</div>
								</a>
							</s:if>
							<s:elseif test='queryType == "1"'>
								<a href="${paginator.actionName}_supplierProducts.action?currentPage=1&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_selected">1</div>
								</a>
							</s:elseif>
							<s:elseif test='queryType == "2"'>
								<a href="${paginator.actionName}_merchantProducts.action?currentPage=1&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_selected">1</div>
								</a>
							</s:elseif>
							<s:elseif test='queryType == "3"'>
								<a href="${paginator.actionName}_disabledProducts.action?currentPage=1&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_selected">1</div>
								</a>
							</s:elseif>
							<s:else>
						...
						<s:bean name= "org.apache.struts2.util.Counter"  id= "counter" >    
							...
							<s:iterator> 
								...
								<li class="content_paginator_li_selected">
									<s:if test='queryType == "0"'>
										<a href="${paginator.actionName}_allProducts.action?currentPage=${current-1}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
											<div class="content_paginator_number_selected">${current-1}</div>
										</a>
									</s:if>
									<s:elseif test='queryType == "1"'>
										<a href="${paginator.actionName}_supplierProducts.action?currentPage=${current-1}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
											<div class="content_paginator_number_selected">${current-1}</div>
										</a>
									</s:elseif>
									<s:elseif test='queryType == "2"'>
										<a href="${paginator.actionName}_merchantProducts.action?currentPage=${current-1}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
											<div class="content_paginator_number_selected">${current-1}</div>
										</a>
									</s:elseif>
									<s:elseif test='queryType == "3"'>
										<a href="${paginator.actionName}_disabledProducts.action?currentPage=${current-1}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
											<div class="content_paginator_number_selected">${current-1}</div>
										</a>
									</s:elseif>
									<s:else>
						...
						<s:if test="paginator.totalPage > 1">
							...
							<li class="content_paginator_li_selected">
								<s:if test='queryType == "0"'>
									<a href="${paginator.actionName}_allProducts.action?currentPage=${paginator.totalPage}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
										<div class="content_paginator_number_selected">${paginator.totalPage}</div>
									</a>
								</s:if>
								<s:elseif test='queryType == "1"'>
									<a href="${paginator.actionName}_supplierProducts.action?currentPage=${paginator.totalPage}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
										<div class="content_paginator_number_selected">${paginator.totalPage}</div>
									</a>
								</s:elseif>
								<s:elseif test='queryType == "2"'>
									<a href="${paginator.actionName}_merchantProducts.action?currentPage=${paginator.totalPage}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
										<div class="content_paginator_number_selected">${paginator.totalPage}</div>
									</a>
								</s:elseif>
								<s:elseif test='queryType == "3"'>
									<a href="${paginator.actionName}_disabledProducts.action?currentPage=${paginator.totalPage}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
										<div class="content_paginator_number_selected">${paginator.totalPage}</div>
									</a>
								</s:elseif>
								<s:else>
						...
						<li class="content_paginator_li content_paginator_number_onhover">
							<s:if test='queryType == "0"'>
								<a href="${paginator.actionName}_allProducts.action?currentPage=${paginator.nextPage}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">下一页</div>
								</a>
							</s:if>
							<s:elseif test='queryType == "1"'>
								<a href="${paginator.actionName}_supplierProducts.action?currentPage=${paginator.nextPage}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">下一页</div>
								</a>
							</s:elseif>
							<s:elseif test='queryType == "2"'>
								<a href="${paginator.actionName}_merchantProducts.action?currentPage=${paginator.nextPage}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">下一页</div>
								</a>
							</s:elseif>
							<s:elseif test='queryType == "3"'>
								<a href="${paginator.actionName}_disabledProducts.action?currentPage=${paginator.nextPage}&queryType=${queryType}&keyword=${keyword}&companyIdSelected=${companyIdSelected}&lastMonth=${lastMonth}">
									<div class="content_paginator_number_3">下一页</div>
								</a>
							</s:elseif>
							<s:else>
