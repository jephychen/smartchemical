			...
			<div class="my_zhixuan_right_content">
				<div class="product_list_filters">
					<div class="product_list_filter_item">
						...
						<div class="product_list_filter_item_right">
							<select class="product_list_filter_item_select" onchange="selectLastmonth(this.value, ${bankAccountId}, ${paginator.currentPage}, ${queryType}, ${lastMonth})" >
					...
					<div class="product_list_filter_item">
						...
						<div class="product_list_filter_item_right">
							<select class="product_list_filter_item_select" onchange="selectAccount(this.value, ${bankAccountId}, ${paginator.currentPage}, ${queryType}, ${lastMonth})" >
								<option value="0">所有账户</option>
								<s:iterator value="accounts" id="account">
									<s:if test='#account.accountId == bankAccountId'>
										<option selected="selected" value="${account.accountId}">${account.companyName} ${account.accountNo}</option>
									</s:if>
									<s:else>
										<option value="${account.accountId}">${account.companyName} ${account.accountNo}</option>
									</s:else>
								</s:iterator>
					...
					<div class="product_list_create_button hover_pointer">
						新建请求
						<div class="new_request_pop">
							<s:if test='userAccounts.size == 0'>
								<div class="new_request_pop_item" onclick="showGetdeposit(0, ${sessionScope.user.depositStr})">
									提现请求
								</div>
							</s:if>
							<s:else>
								<div class="new_request_pop_item" onclick="showGetdeposit(1, ${sessionScope.user.depositStr})">
									提现请求
								</div>
							</s:else>
							<div class="new_request_pop_item" onclick="showTransferdeposit(${sessionScope.user.depositStr})">
								代付请求
							</div>
						</div>
					</div>
				...
				<div class="order_page_product_list_title_wrapper">
					<div class="order_page_product_list_title">
						...
						<div class="order_page_product_list_title_accountname">
							<font class="order_page_font_gray"><div class="order_page_product_price_wrapper">目标账户名</div></font>
						</div>
				...
				<s:iterator value="requests" id="request">
					...
					<div class="order_page_product_list_title_accountno_content">
						<font class="order_page_font_gray"><div class="order_page_product_price_wrapper">${request.destAccount.accountNo}</div></font>
					</div>
					<div class="order_page_product_list_title_accountname">
						<font class="order_page_font_gray"><div class="order_page_product_price_wrapper">${request.destAccount.companyName}</div></font>
					</div>
					<div class="order_page_product_list_title_company">
						<font class="order_page_font_gray"><div class="order_page_product_price_wrapper">￥${request.amount}</div></font>
					</div>
					<div class="order_page_product_list_title_status">
					...
					<div class="order_page_product_list_title_op">
						<s:if test="#request.requestStatus == 1">
							<font class="order_page_font_red"><div class="order_page_product_price_wrapper hover_pointer" onclick="deleteRequest(${request.requestId}, ${bankAccountId}, ${paginator.currentPage}, ${queryType}, ${lastMonth})" >取消</div></font>
						</s:if>
					</div>
				</div>
				</s:iterator>
				<div id="content_paginator">
					<ul class="content_paginator_ul">
						<li class="content_paginator_li content_paginator_number_onhover">
							<a href="DepositRequestManagement_allRequest.action?bankAccountId=${bankAccountId}&currentPage=${paginator.prePage}&queryType=${queryType}&lastMonth=${lastMonth}">
								<div class="content_paginator_number_3">上一页</div>
							</a>
						</li>
						<s:if test="paginator.currentPage == 1">
						<li class="content_paginator_li_selected">
							<a href="DepositRequestManagement_allRequest.action?bankAccountId=${bankAccountId}&currentPage=1&queryType=${queryType}&lastMonth=${lastMonth}">
						...
						<s:bean name= "org.apache.struts2.util.Counter"  id= "counter" >    
							...
							<s:iterator> 
								...
								<li class="content_paginator_li_selected">
									<a href="DepositRequestManagement_allRequest.action?bankAccountId=${bankAccountId}&currentPage=${current-1}&queryType=${queryType}&lastMonth=${lastMonth}">
						...
						<s:if test="paginator.totalPage > 1">
							...
							<li class="content_paginator_li_selected">
								<a href="DepositRequestManagement_allRequest.action?bankAccountId=${bankAccountId}&currentPage=${paginator.totalPage}&queryType=${queryType}&lastMonth=${lastMonth}">
						...
						<li class="content_paginator_li content_paginator_number_onhover">
							<a href="DepositRequestManagement_allRequest.action?bankAccountId=${bankAccountId}&currentPage=${paginator.nextPage}&queryType=${queryType}&lastMonth=${lastMonth}">
						...
						<li class="content_paginator_li">
							<form name="page_form" action="DepositRequestManagement_allRequest.action">
